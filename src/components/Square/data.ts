...
SquareConfigData.set(3, { type: SquareType.Chest, section: BoardSection.Bottom });
SquareConfigData.set(4, { type: SquareType.Property, section: BoardSection.Bottom, groupId: 1 });
SquareConfigData.set(5, { type: SquareType.Utility, section: BoardSection.Bottom });

SquareConfigData.set(6, { type: SquareType.Railroad, section: BoardSection.Bottom, groupId: 10 });
...
SquareConfigData.set(11, { type: SquareType.Jail, section: BoardSection.Corner });

SquareConfigData.set(12, { type: SquareType.Property, section: BoardSection.Left, groupId: 3 });
SquareConfigData.set(13, { type: SquareType.Utility, section: BoardSection.Left });
...
SquareConfigData.set(16, { type: SquareType.Railroad, section: BoardSection.Left, groupId: 10 });
...
SquareConfigData.set(21, { type: SquareType.FreePark, section: BoardSection.Corner });
...
SquareConfigData.set(26, { type: SquareType.Railroad, section: BoardSection.Top, groupId: 10 });

SquareConfigData.set(27, { type: SquareType.Property, section: BoardSection.Top, groupId: 6 });
SquareConfigData.set(28, { type: SquareType.Property, section: BoardSection.Top, groupId: 6 });
SquareConfigData.set(29, { type: SquareType.Utility, section: BoardSection.Top });
SquareConfigData.set(30, { type: SquareType.Property, section: BoardSection.Top, groupId: 6 });

SquareConfigData.set(31, { type: SquareType.GoToJail, section: BoardSection.Corner });

SquareConfigData.set(32, { type: SquareType.Property, section: BoardSection.Right, groupId: 7 });
SquareConfigData.set(33, { type: SquareType.Property, section: BoardSection.Right, groupId: 7 });
SquareConfigData.set(34, { type: SquareType.Chest, section: BoardSection.Right });
SquareConfigData.set(35, { type: SquareType.Property, section: BoardSection.Right, groupId: 7 });

SquareConfigData.set(36, { type: SquareType.Railroad, section: BoardSection.Right, groupId: 10 });

SquareConfigData.set(37, { type: SquareType.Chance, section: BoardSection.Right });

SquareConfigData.set(38, { type: SquareType.Property, section: BoardSection.Right, groupId: 8 });
SquareConfigData.set(39, { type: SquareType.Utility, section: BoardSection.Right });
